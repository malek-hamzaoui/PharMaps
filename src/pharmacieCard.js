...
function PharmacieCard({ name, distance, dureeVoiture, duree,status }) {
    ...
    return (
        <>
            <div className="max-w-xs rounded overflow-hidden shadow-lg m-4 py-4 px-4">
                ...
                <p className="text-gray-700 text-base font-bold" style={{ color: status === "en stock" ?  "green" : status==="en arrivage" ? "orange" : "red" }}>{status}</p>
            </div>
